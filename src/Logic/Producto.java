...
public class Producto {
    ...
    public Producto(String nombre, String categoria, float precio_compra, 
            float precio_venta, int codigo_serial, String proveedor, String fecha_vencimiento, int cantidad) {
        this.nombre = nombre;
        this.categoria = categoria;
        this.precio_compra = precio_compra;
        this.precio_venta = precio_venta;
    ...
    public Producto(String nombre, String categoria, float precio_venta, int codigo_serial, String fecha_vencimiento, int cantidad) {
        this.nombre = nombre;
        this.categoria = categoria;
        this.precio_venta = precio_venta;
        this.codigo_serial = codigo_serial;
    ...
    public String toString() {
        return "Producto {" + "nombre = " + nombre + ", categoria = " + categoria + 
                ...
                ", fecha_vencimiento = " + fecha_vencimiento + '}' + " x " + cantidad;
    }

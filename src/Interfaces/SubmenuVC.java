 ...
 * @author Usuario
 */
public class SubmenuVC extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubmenuVC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
